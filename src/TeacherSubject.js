...
const TeacherSubject = ({ userName, role }) => {
    ...
    const handleSubmit = async(e) => {
        ...
        clear();
        getSubjectByTeacherId(response.id);
    ...
    const confirmDelete = () => {
        ...
        const url = `${api_url}/delete-teacherSubjects`;
    ...
    return (
        <Fragment>
           ...
           <div className='mid-body'>
            ...
            <div className="navbar-heading">Add Teacher</div>
            ...
            <div className="custom-col">
                ...
                <input type='text' className={`form-control ${validationErrors.name ? 'is-invalid' : ''}`} placeholder='Enter name' value={name} 
                 onChange={handleNameChange} disabled={submitted} />
                </div>
                <div className="custom-col">
                ...
                onChange={handleEmailChange} disabled={submitted} />
                </div>
                <div className="custom-col">
                ...
                onChange={handleMobileChange} disabled={submitted} />
                </div>
            </div>
            <div className='edit-save'>
                <button className='custom-btn custom-btn-primary width' onClick={handleSubmit}>
                    Save
                </button>
            </div>
            <div>
                                ...
                                data.map((item, index)=>{
                                    ...
                                    return(
                                        <tr key={index}>
                                            ...
                                            <td colSpan={2}>
                                            <Tooltip title="Edit Details"><span><button className='custom-btn custom-btn-primary' id='edit-btn' onClick={() =>  {getClassByCourse(item.courseId); getSections(item.classId); getSubjects(item.classId); handleEdit(item.id);}}><BorderColorIcon /></button></span></Tooltip>&nbsp;
                                            </td>
                                        </tr>
                                    )
                                })
